...
export default function SocialShareButton({
    ...
    if (shared) {
        return (
            <div className="flex items-center gap-2 bg-green-600/20 text-green-400 font-bold py-2 px-4 rounded-lg">
    ...
    return (
        <button
            ...
            disabled={loading}
            className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg disabled:opacity-50 transition-colors"
        >
