...
class ApiService {
    ...
    // Duel endpoints
    async createDuel(data: { duel_id?: number; bet_amount: number; market_id?: string; event_id?: string; predicted_outcome?: string; currency?: string; signature: string }): Promise<any> {
